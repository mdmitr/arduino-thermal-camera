...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        SettingsDialog.resize(445, 531)
        SettingsDialog.setMinimumSize(QtCore.QSize(445, 475))
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 20, 363, 152))
        ...
        self.gridLayout_2.addWidget(self.pb_test_lrMin, 0, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pb_test_lrCenter, 2, 2, 1, 1)
        self.pb_test_lrMax = QtWidgets.QPushButton(self.gridLayoutWidget)
        self.pb_test_lrMax.setObjectName("pb_test_lrMax")
        self.gridLayout_2.addWidget(self.pb_test_lrMax, 1, 2, 1, 1)
        ...
        self.spin_lrStep = QtWidgets.QSpinBox(self.gridLayoutWidget)
        self.spin_lrStep.setObjectName("spin_lrStep")
        self.gridLayout_2.addWidget(self.spin_lrStep, 3, 1, 1, 1)
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 20, 370, 132))
        ...
        self.gridLayout_3.addWidget(self.pb_test_udCenter, 2, 2, 1, 1)
        ...
        self.spin_udStep = QtWidgets.QSpinBox(self.gridLayoutWidget_2)
        self.spin_udStep.setObjectName("spin_udStep")
        self.gridLayout_3.addWidget(self.spin_udStep, 3, 1, 1, 1)
        ...
        self.label_grid_info = QtWidgets.QLabel(self.groupBox_3)
        self.label_grid_info.setGeometry(QtCore.QRect(10, 10, 401, 61))
        self.label_grid_info.setObjectName("label_grid_info")
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.label_8.setText(_translate("SettingsDialog", "Step microseconds"))
        ...
        self.label_9.setText(_translate("SettingsDialog", "Step microseconds"))
        self.groupBox_3.setTitle(_translate("SettingsDialog", "Thermal image info"))
        self.label_grid_info.setText(_translate("SettingsDialog", "Thermal image info:"))
